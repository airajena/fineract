...
import org.apache.fineract.portfolio.note.repository.NoteJdbcRepository;
...
@Configuration
@EnableJdbcRepositories(basePackages = "org.apache.fineract.portfolio.note.repository", repositoryFactoryBeanClass = QuerydslJdbcRepositoryFactoryBean.class)

public class NoteAutoConfiguration {

    @Bean
    @ConditionalOnMissingBean
    public NoteQuerydslReadRepository noteQuerydslReadRepository(NoteJdbcRepository noteJdbcRepository) {
        return new NoteQuerydslReadRepository(noteJdbcRepository);
    }
